  ...
  return (
    <>
      <section className="rounded-lg border bg-gradient-to-br from-background to-muted/20 p-8 text-center">
        <h2 className="text-2xl font-semibold mb-3">{t('startPage.welcome.title', 'Welcome to Noli CRM')}</h2>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-emerald-800/80 dark:text-emerald-200/90">
                  {t('startPage.onboarding.description', 'Create a tenant, organization, and administrator account in minutes. We\'ll verify your email and deliver a pre-seeded environment so you can explore Noli CRM with real data.')}
                </p>
              </div>
