          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-2 max-w-sm mx-auto">
              {[
                ...
                // Realtors: suggest "Answer routine requests" (reply mode 'assisted'; off until they turn it on).
                ...(businessType === 'realestate'
                  ? [{ href: '/backend/customer-service?tab=settings', icon: MessageSquare, title: 'Let Noli answer showing requests', desc: 'Turn on Answer routine requests: routine questions get answered during your hours, the rest waits for you' }]
                  : []),
              ].map(item => (
