export const metadata = { title: 'Terms &amp; Conditions — Noli CRM CRM' }
...
export default function TermsPage() {
  ...
  return (
    <div style={s.page}>
      <h1 style={s.h1}>Noli CRM CRM — Terms &amp; Conditions</h1>
      <p style={s.updated}>Last updated: April 6, 2026</p>

      <div style={s.callout}>
        <strong>Incorporation of Company-Wide Terms:</strong> <a href="https://thelaunchpadincubator.com/terms/" style={s.link}>Noli LLC Terms &amp; Conditions</a> are expressly incorporated into and made a part of these Terms by reference. All terms and provisions of the company-wide terms apply to your use of the Noli CRM CRM platform, except where they directly conflict with the terms set forth in this document, in which case the terms of this document shall control with respect to the Platform.
      </div>

      <p style={s.p}>These Terms of Service ("Terms") constitute a legally binding agreement between you ("User," "you," "your") and Noli LLC ("Company," "we," "our," "us"), governing your access to and use of the Noli CRM CRM platform at crm.thelaunchpadincubator.com (the "Platform"). By creating an account, accessing, or using the Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and our <a href="/privacy" style={s.link}>Privacy Policy</a>.</p>
      ...
      <p style={s.p}>Nothing in these Terms grants you any right to use the Company{"'"}s trademarks, logos, branding, or trade names. You may not display, modify, or use the Noli CRM name, Scout name, or any related branding without prior written permission from the Company.</p>
