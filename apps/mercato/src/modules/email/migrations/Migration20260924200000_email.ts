...
export class Migration20260924200000_email extends Migration {
  override async up(): Promise<void> {
    this.addSql(globalUniqueIndexSql({ table: 'email_messages', column: 'tracking_id', index: 'email_messages_tracking_id_global_uniq', where: 'tracking_id IS NOT NULL' }))
  }

  override async down(): Promise<void> {
    this.addSql(`DROP INDEX IF EXISTS "email_messages_tracking_id_global_uniq";`)
  }
}
