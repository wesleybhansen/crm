...
export class Migration20260902180000_gtm extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "gtm_social_connections" add constraint "gtm_social_connections_org_provider_user_unique" unique ("organization_id", "tenant_id", "provider", "provider_user_id");`);
  }
