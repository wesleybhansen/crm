...
export class Migration20260924200000_courses extends Migration {
  override async up(): Promise<void> {
    this.addSql(globalUniqueIndexSql({ table: 'courses', column: 'slug', index: 'courses_slug_global_uniq', where: 'deleted_at IS NULL' }))
  }

  override async down(): Promise<void> {
    this.addSql(`DROP INDEX IF EXISTS "courses_slug_global_uniq";`)
  }
}
