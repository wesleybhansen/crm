...
export class Migration20260924200000_forms extends Migration {
  override async up(): Promise<void> {
    this.addSql(globalUniqueIndexSql({ table: 'forms', column: 'slug', index: 'forms_slug_global_uniq' }))
  }

  override async down(): Promise<void> {
    this.addSql(`DROP INDEX IF EXISTS "forms_slug_global_uniq";`)
  }
}
