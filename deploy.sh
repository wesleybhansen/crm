...
echo "     */10 * * * * curl -s -X POST http://localhost:3000/api/sequences/automation-rules/run-scheduled -H 'Authorization: Bearer YOUR_SEQUENCE_PROCESS_SECRET'"
echo "     */5 * * * * curl -s -X POST http://localhost:3000/api/internal/outbound-events/drain -H 'Authorization: Bearer YOUR_SEQUENCE_PROCESS_SECRET'"
